...
constants=%1 ^
fetch_data=%1 ^
preprocess=%2%6 preprocess.params.selector.params.n_features=%5 %theilu% ^
train_test_split=stratified train_test_split.params.random_state=%4 ^
model=%3 ^
evaluation=ml.yaml ^
export=mlflow.yaml export.params.experiment_name=%1"__feat_selection"%6"__"%2"__model__"%3"__features__"%5