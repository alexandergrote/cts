...
from src.fetch_data.base import BaseResultDataloader


client = get_mlflow_client()


class QueryEngine(BaseResultDataloader, BaseModel):
...
if __name__ == '__main__':
    ...
    data = mlflow_engine.get_results_of_single_experiment(experiment_name="feat_selection__churn", n=5)
