...
class Dataset(BaseModel):
    ...
    def get_number_observations(self) -> int:
        return self.raw_data[DatasetSchema.id_column].nunique()
    ...
    def get_number_positives(self) -> int:
        ...
        return self.raw_data[self.raw_data[DatasetSchema.class_column] == 1][DatasetSchema.id_column].nunique()
    ...
    def get_number_negatives(self) -> int:
        ...
        return self.raw_data[self.raw_data[DatasetSchema.class_column] == 0][DatasetSchema.id_column].nunique()
